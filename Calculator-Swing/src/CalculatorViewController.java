...
/**
 * The Class CalculatorViewController.The class CalculatorViewController is
 * responsible for building and operating the calculator GUI. It extends JPanel.
 * All the buttons, and their details are in this class
 * 
...
public class CalculatorViewController extends JPanel {
	...
	int[] buttonKeys = { KeyEvent.VK_7, KeyEvent.VK_8, KeyEvent.VK_9, KeyEvent.VK_SLASH, KeyEvent.VK_4, KeyEvent.VK_5,
			KeyEvent.VK_6, KeyEvent.VK_ASTERISK, KeyEvent.VK_1, KeyEvent.VK_2, KeyEvent.VK_3, KeyEvent.VK_MINUS,
			KeyEvent.VK_0, KeyEvent.VK_DECIMAL, -1, KeyEvent.VK_PLUS };

	/** The numeric keys. */
	// Numeric Keys on the Keyboard
	int[] numericKeys = { KeyEvent.VK_NUMPAD7, KeyEvent.VK_NUMPAD8, KeyEvent.VK_NUMPAD9, KeyEvent.VK_DIVIDE,
			KeyEvent.VK_NUMPAD4, KeyEvent.VK_NUMPAD5, KeyEvent.VK_NUMPAD6, KeyEvent.VK_MULTIPLY, KeyEvent.VK_NUMPAD1,
			KeyEvent.VK_NUMPAD2, KeyEvent.VK_NUMPAD3, KeyEvent.VK_SUBTRACT, KeyEvent.VK_NUMPAD0, KeyEvent.VK_DECIMAL,
			-1, KeyEvent.VK_ADD };
	...
	public CalculatorViewController() {
		...
		super.setBorder(new MatteBorder(MATTE_BORDER_SIZE, MATTE_BORDER_SIZE, MATTE_BORDER_SIZE, MATTE_BORDER_SIZE,
				Color.BLACK));
		...
		for (int i = 0; i < buttonName.length; i++) {
			...
			if (buttonName[i] == "/" || buttonName[i] == "*" || buttonName[i] == "-" || buttonName[i] == "+") {
				button = createButton(buttonName[i], buttonName[i], Color.BLACK, Color.CYAN, new Controller());

			} else if (buttonName[i] == "\u00B1") {
				button = createButton(buttonName[i], buttonName[i], Color.BLACK, Color.PINK, new Controller());

			} else {

				button = createButton(buttonName[i], buttonName[i], Color.BLACK, Color.BLUE, new Controller());
			}
			...
			if (buttonKeys[i] != -1) {
				...
				button.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(buttonKeys[i], 0),
						buttonName[i]);
			...
			if (numericKeys[i] != -1) {
				...
				button.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(numericKeys[i], 0),
						buttonName[i]);
	...
	private class Controller implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getActionCommand().equals(".")) {
				 ...
				 * dotButton.setEnabled(false); dotButton.setOpaque(true);
				 * dotButton.setVisible(false); display2.setText("0");
				 * 
				 * for (int i = 0; i < center.getComponentCount(); i++) {
				 * 
				 * center.getComponent(i).setEnabled(true);
