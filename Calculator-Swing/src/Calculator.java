...
/**
 * The Class Calculator. This class is responsible for launching the
 * application. The class contains a main method only. Inside the main method
 * you must first create a CaclculatorSplashScreen object and call its
 * showSplashWindow() method and display the splash screen for 5 s. Then the
 * main method must call EventQueue.invokeLater() method with a Runnable
 * instance the run() method of which creates a JFrame object; sets the frame
 * title and minimum size; sets the default close operation for the frame; sets
 * the content pane of the frame to a CalculatorViewController object; sets the
...
public class Calculator {
	...
	/**
	 * The main method here runs the whole GUI Frame, sets the title of the Frame
	...
	public static void main(String args[]) {
		...
		/*
		 * Create an Object of CalculatorSplashScreen so that we can create a Splash
		 * Screen when we start the GUI
		 */
