...
/**
 * The Class CalculatorSplashScreen. This class is responsible for displaying a
 * splash screen before the launch of the application. The splash screen
 * displays an image, and contains my name and student number at the bottom of
 * the screen.
 * 
...
public class CalculatorSplashScreen extends JWindow {
	...
	/**
	 * Responsible for Showing a splash screen in the center of the desktop with a
	 * image, name and student number for the amount of time given in the
	 * constructor.
	 */
